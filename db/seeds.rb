...
Job.create! title:"Crib Building", description:"Need help with building a crib for upcoming twins!", qualifications:"Woodworking skill and dedication", pay: 700, contact:"lucaspettinato@gmail.com / 9234567654", date_published:"08/03/2015", user_id: first_user.id, accepted: true
...
Job.create! title:"Stacking Firewood", description:"A few hours worth of stacking lumber for the winter", qualifications:"Able to lift up to 30 lbs", pay: 500, contact:"ian@gmail.com / 2384756456", date_published:"08/02/2015", user_id: second_user.id, accepted: false
Job.create! title:"Sink Needs Fixing", description: "Need to fix sink plumbing", qualifications: "Experience with fixing utilities", pay: 300, contact: "ian@gmail.com / 2384756456", date_published: "8/06/2015", user_id: second_user.id, accepted: false
...
Job.create! title:"Cleaning Gutters", description:"Need assistance in cleaning mud out of gutters", qualifications:"3 hours of time available", pay: 400, contact:"ericadu@gmail.com / 2439872349", date_published:"08/04/2015", user_id: third_user.id, accepted: false
Job.create! title:"Help Building a Shelf", description: "I need someone to help me build a shelf in my living room", qualifications: "Strong and, preferebly, tall", pay: 500, contact: "ericadu@gmail.com / 2439872349", date_published: "8/05/2015", user_id: third_user.id, accepted: false
...
Job.create! title:"Tour Guide at Community Center", description: "Need someone familiar with the community center to give tour", qualifications:"Outgoing", pay:400, contact:"elderhan@gmail.com/2309840983", date_published: "8/06/2015", user_id: fourth_user.id, accepted: true
...
sample_job = Job.create! title:"Building shed", description: "Need someone to assist with building a shed for equipment", qualifications:"Experience in carpentry",pay: 800, contact: "elderhan@gmail.com/2309840983", date_published: "7/24/2015", user_id: fourth_user.id, accepted: false

Application.create! name: "Ian Schoonover", contact: "ian@gmail.com/9784738201", address: "Cape Town", skills: "Woodworking, Carpentry", past_experiences: "Fixes cabinets, doors, shelves", summary: "Always willing to work and help out", user_id: second_user.id, job_id: sample_job.id